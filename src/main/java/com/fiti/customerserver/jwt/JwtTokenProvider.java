package com.fiti.customerserver.jwt;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fiti.customerserver.response.exception.BusinessException;
import com.fiti.customerserver.security.CustomUserDetails;
import com.fiti.customerserver.security.UserPrincipalDto;
...
public class JwtTokenProvider {
    ...
    @PostConstruct
    public void setKey(){ //jwt.secret을 이용하여 key생성
        byte[] keyBytes = Decoders.BASE64.decode(secret);
        this.key = Keys.hmacShaKeyFor(keyBytes);
    }

    //토큰 발급
    public AccountDto.Tokens generateTokens(Authentication authentication) throws JsonProcessingException {
        ...
        return new AccountDto.Tokens(accessToken, refreshToken);
    }
